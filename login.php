...
<div class="container">
    <div class="header">
        <h2>MyFood</h2>
        <a id="kembali" href="#"><i class="fa-solid fa-arrow-left"></i></a>
        <h3>LOG IN</h3>
    </div>
...
<script>
    ...
    // Temukan elemen tautan kembali
    var linkKembali = document.getElementById('kembali');

    // Tambahkan event listener untuk menanggapi klik
    if (linkKembali) {
        linkKembali.addEventListener('click', function (event) {
